...
const LiveTranscript = ({ socket, streamId, videoRef }) => {
  ...
  if (loading)
    return (
      <div className="text-gray-600 text-sm italic p-4">
        Loading transcript...
      </div>
    );
  ...
  return (
    <div
      ref={containerRef}
      className="bg-gray-950 text-white p-4 rounded-lg font-mono w-full space-y-2 max-h-[90%] overflow-y-auto overflow-x-hidden"
    >
